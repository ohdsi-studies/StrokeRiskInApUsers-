...
shinySettings <- list(dataFolder = "S:/StudyResults/epi_581_5/shinyDataAll", blind = FALSE)
...
exposureOfInterest$exposureName <- relabel(exposureOfInterest$exposureName, "[Epi 581] T3. New users of typical antipsychotics age 65 years and older", "T3. Typical antipsychotics, 65 years and older")
exposureOfInterest$exposureName <- relabel(exposureOfInterest$exposureName, "[Epi 581] T4. New users of haloperidol age 65 years and older", "T4. Haloperidol, 65 years and older")
exposureOfInterest$exposureName <- relabel(exposureOfInterest$exposureName, "[Epi 581] T5. New users of typical antipsychotics age 18-64", "T5. Typical antipsychotics, 18-64 years")
exposureOfInterest$exposureName <- relabel(exposureOfInterest$exposureName, "[Epi 581] T6. New users of haloperidol aged 18 to 64 years", "T6. Haloperidol, 18-64 years")
...
exposureOfInterest$exposureName <- relabel(exposureOfInterest$exposureName, "[Epi 581] C2. New users of atypical antipsychotics aged 65 years and older", "C2. Atypical antipsychotics, 65 years and older")
exposureOfInterest$exposureName <- relabel(exposureOfInterest$exposureName, "[Epi 581] C3. New users of atypical antipsychotics age 18-64", "C3. Atypical antipsychotics, 18-64 years")
