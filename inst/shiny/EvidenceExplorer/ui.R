...
shinyUI(
  fluidPage(style = "width:1500px;",
            titlePanel(paste("Stroke risk among new users of typical vs. atypical antipsychotics stratified by broad age group", if(blind) "***Blinded***" else "")),
            ...
            tabsetPanel(id = "mainTabsetPanel",
                        tabPanel("About",
                                 ...
                                 HTML("<p><strong>Conclusion: </strong></p>"),
                                 HTML("<br/>"),
            ...
            fluidRow(
              column(4,
                     selectInput("target", "Target", unique(exposureOfInterest$exposureName[1:6]), selected = unique(exposureOfInterest$exposureName)[1], width = '95%'),
                     selectInput("comparator", "Comparator", unique(exposureOfInterest$exposureName[7:9]), selected = unique(exposureOfInterest$exposureName)[7], width = '95%'),
