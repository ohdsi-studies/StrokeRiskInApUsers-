...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (766529)and invalid_reason is null
...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (794852,756018,792263,709699,733008,700299,700465,704984)and invalid_reason is null
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (794852,756018,792263,709699,733008,700299,700465,704984)
  and c.invalid_reason is null
...
(
  select de.* 
  FROM @cdm_database_schema.DRUG_EXPOSURE de
JOIN #Codesets codesets on ((de.drug_source_concept_id = codesets.concept_id and codesets.codeset_id = 15))
) C
