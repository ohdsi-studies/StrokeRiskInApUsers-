...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (374060,376713,4108356,46273649,4110192,4043731,432923,443454,436430,44837110,44835947,44830088,44826644,45538392,45605805,45557548,45548025,1569191)and invalid_reason is null
...
WHERE C.condition_type_concept_id  in (38000183,38000199,44786627,38000248,38000250)
