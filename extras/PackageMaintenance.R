...
OhdsiRTools::checkUsagePackage("epi581v4")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/epi581v4.pdf")
shell("R CMD Rd2pdf ./ --output=extras/epi581v4.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("epi581v4")
